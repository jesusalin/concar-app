...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('registro_compras', function (Blueprint $table) {
            ...
            $table->foreignId('tercero_id')->constrained('terceros'); // proveedor
            $table->foreignId('asiento_id')->nullable()->constrained('asientos')->nullOnDelete();
            $table->enum('tipo_comprobante', ['Factura', 'Boleta', 'Recibo por Honorarios', 'Nota de Credito', 'Nota de Debito'])->default('Factura');
